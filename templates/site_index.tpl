{include file="site_head.tpl"}    
    ...
    <div id="top">
        ...
        <center><br/><br/><h1>{$SITE.title} - Max 36 Chars</h1></center>
        ...
        <div class="container clearfix">
            ...
            <div id="offer" class="clearfix">
                ...
                <div id="offercontent">
                    ...
                    <h3>{$SITE.offer_subhead} - (27 Chars)</h3>
                    
                    <div id="offercontent-wrap">
                    
                        <p class="description">{$SITE.offer_description} (Max Chars 550)</p>
    ...
    <div id="content" class="clearfix">
        ...
        <div class="container clearfix" style="padding-top: 90px;">
            ...
            <div class="col-full">
            <h3>{$SITE.content_headline}</h3>
            <p class="description">{$SITE.content_html}HTML box (Tiny MCE) with unlimited code/text</p>
